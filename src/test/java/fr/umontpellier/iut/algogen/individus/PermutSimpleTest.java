...
public class PermutSimpleTest {
	...
	public void testCalculerCroisement() throws Exception {
		...
		individu.get(1).permut = new ArrayList<>(Arrays.asList(6, 36, 3, 23, 41, 24, 37, 17, 44, 38, 20, 42, 0, 25, 33,
				30, 39, 31, 21, 11, 10, 28, 18, 48, 27, 49, 29, 2, 47, 46, 22, 12, 8, 40, 4, 13, 1, 9, 7, 43, 34, 15,
				19, 16, 14, 45, 26, 5, 32, 35));
